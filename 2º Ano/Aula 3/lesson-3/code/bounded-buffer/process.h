...
/**
 *  \brief `execlp` wrapper function.
 *
 *  \details Other documentation in @verbatim man 3 execlp @endverbatim
 *
 *  @see https://man.cx/execlp(3)
 */
void pexeclp(const char *file, const char *arg, ... /* (char  *) NULL */);

/**
 *  \brief `execle` wrapper function.
 *
 *  \details Other documentation in @verbatim man 3 execle @endverbatim
 *
 *  @see https://man.cx/execle(3)
 */
